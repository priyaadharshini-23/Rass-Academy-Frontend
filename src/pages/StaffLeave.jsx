...
export default function StaffLeaveManagement() {
  ...
  const handleSave = () => {
    const finalStaff =
      form.staff === "Others" ? form.customStaff : form.staff;

    const finalReason =
      form.reason === "Others" ? form.customReason : form.reason;

    if (!finalStaff || !form.date || !form.from || !form.to || !finalReason)
      return;
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Staff Leave");
    XLSX.writeFile(wb, "staff_leave_management.xlsx");
  };
    ...
    <div className="p-4 sm:p-6 md:p-8 space-y-6 text-gray-800">
      ...
      <div className="bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] border overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-gray-800 min-w-[900px]">
        ...
        createPortal(
          <div className="fixed inset-0 z-[9999]">
            ...
            <div className="absolute inset-0 flex justify-center items-start sm:items-center p-4 overflow-y-auto">
              <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_25px_80px_rgba(0,0,0,0.3)]">
                  ...
                  <div>
                    ...
                    {form.staff === "Others" && (
                      <input
                        ...
                        value={form.customStaff}
                        onChange={(e) =>
                          setForm({
                            ...form,
                            customStaff: e.target.value,
                          })
                        }
